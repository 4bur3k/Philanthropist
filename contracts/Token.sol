...
contract TokenERC20 {
    ...
    // Confirming that _value is not negative and user's balance big enought
    ...
    //Cheking permission to transacts for wallet
    ...
    constructor() public{
        ...
        token = msg.sender;                              // Set the symbol for display purposes
    }
    ...
    function balOf(address _owner) public view returns(uint){
